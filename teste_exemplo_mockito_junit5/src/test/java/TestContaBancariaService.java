...
import com.example.ContaBancariaService;
...
public class TestContaBancariaService {
    ...
    public void setUp() {
        ...
        bancoService = new ContaBancariaService(repositoryMock);
    ...
    public void testContaNaoEncontrada() {
        ...
        // Verificar se a exceção é lançada ao tentar realizar operações em conta
        // inexistente
        assertThrows(IllegalArgumentException.class, () -> {
